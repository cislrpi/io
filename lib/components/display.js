...
module.exports = function () {
    function Display(io, screenName) {
        var _this = this;
    ...
    _createClass(Display, [{
        ...
        */
        ...
        key: 'getFocusedWindow',
        value: function getFocusedWindow() {
            var _this2 = this;
            ...
            return this._postRequest(cmd).then(function (m) {
                ...
                if (opt.window_id && _this2.displayWindows.has(opt.window_id)) {
                    return _this2.displayWindows.get(opt.window_id);
                } else {
                    return null;
                }
            });
        ...
        */
        ...
        value: function createWindow(options) {
            ...
            return this._postRequest(cmd).then(function (m) {
                // console.log(m.toString())
                var opt = JSON.parse(m.toString());
                return new DisplayWindow(_this3, opt);
            });
        }
    }, {
        key: 'getAllContexts',
        ...
        value: function getAllWindowIds() {
            return [].concat(_toConsumableArray(this.displayWindows.keys()));
        }
    }, {
        ...
        value: function getAllViewObjectIds() {
            return [].concat(_toConsumableArray(this.viewObjects.keys()));
        }
    }, {
