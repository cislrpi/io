        ...
        this.io.onTopic("display.removed", function (m) {
            ...
            _this.io.getStore().getHash("dc." + _this.name).then(function (m) {
                if (m != null) {
                    ...
                    _this.io.getStore().addToHash("dc." + _this.name, "displayWinObjMap", mobj);
                    _this.io.getStore().addToHash("dc." + _this.name, "viewObjDisplayMap", vobj);
                }
            });
        });
    ...
    _createClass(DisplayContext, [{
        ...
        */
        ...
        value: function createViewObject(screenName, options) {
            ...
            return this.displayWindows.get(screenName).createViewObject(options).then(function (vo) {
                ...
                try {
                    for (var _iterator9 = _this7.viewObjects[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
