...
module.exports = function () {
    function DisplayContext(name, options, io) {
        ...
        this.io.onTopic("display.*", function (m) {
    ...
    _createClass(DisplayContext, [{
        ...
        key: 'getDisplayWindowById',
        value: function getDisplayWindowById(window_id) {
        ...
        */
        ...
        value: function createViewObject(windowName, options) {
            var _this7 = this;
