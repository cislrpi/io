...
module.exports = function (_EventEmitter) {
    ...
    function Hotspot(io, region, excludeEventsOutsideRegion) {
        ...
        var _this = _possibleConstructorReturn(this, (Hotspot.__proto__ || Object.getPrototypeOf(Hotspot)).call(this));
        ...
        io.onTopic('*.absolute.pointing', function (msg) {
            ...
            if (Array.isArray(pointers)) {
                ...
                _this._generateEvents(_this._intersect(pointers));
            }
        });
            ...
            if (this.plane) {
                ...
                if (pointer.aim) {
                    ...
                    if (distanceAlongRay) {
                        ...
                        return { x: x, y: y, hit: hit, distanceAlongRay: distanceAlongRay, distanceAlongNormal: distanceAlongNormal, details: pointer };
                    }
                } else {
                    return {
