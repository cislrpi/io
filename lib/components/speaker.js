...
module.exports = function () {
    ...
    _createClass(Speaker, [{
        ...
        value: function speak(text, options) {
            ...
            options.text = text;
            return this.io.call('text.speaker.command', JSON.stringify(options), { expiration: this.expiration }, this.expiration);
        }
    }, {
        key: 'onSpeak',
        value: function onSpeak(handler, noAck) {
            this.io.onCall('text.speaker.command', function (msg, _, __, ackFunc) {
