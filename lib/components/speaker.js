...
module.exports = function () {
    ...
    _createClass(Speaker, [{
        ...
        key: 'doSpeak',
        value: function doSpeak(handler, noAck) {
            this.io.onCall('text.speaker.command', function (msg, _, ackFunc) {
        ...
        key: 'doStop',
        value: function doStop(handler) {
            this.io.onCall('stop.speaker.command', function () {
                return handler();
            });
        }
    }, {
