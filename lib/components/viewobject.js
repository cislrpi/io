...
module.exports = function (_EventEmitter) {
    ...
    function ViewObject(display, options) {
        ...
        _this.o_width = options.width;
        _this.o_height = options.height;
        _this.o_diagonal = Math.sqrt(Math.pow(_this.o_width, 2) + Math.pow(_this.o_height, 2));
    ...
    _createClass(ViewObject, [{
        ...
        value: function setBounds(options) {
            ...
            if (options.scaleContent) {
                var w = parseFloat(options.width);
                var h = parseFloat(options.height);
                var dia = Math.sqrt(Math.pow(w, 2) + Math.pow(h, 2));
