...
module.exports = function () {
    ...
    _createClass(CELIO, [{
        ...
        key: 'setActiveAppContext',
        value: function setActiveAppContext(name) {
            var _this = this;
            ...
            return this.getStore().getHash("display.screens").then(function (m) {
                var promises = [];
                ...
                try {
                    for (var _iterator = m[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        promises.push(_this.call("display-rpc-queue-" + k[0], JSON.stringify(cmd)));
                    }
                } catch (err) {
