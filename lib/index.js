...
module.exports = function () {
    ...
    _createClass(CELIO, [{
        ...
        key: 'call',
        value: function call(queue, content, timeout) {
            var _this = this;
                    ...
                    _this._connectBroker().then(function (conn) {
                        return conn.createChannel().then(function (ch) {
                            return ch.assertQueue('', { exclusive: true }).then(function (q) {
                                ...
                                ch.sendToQueue(queue, Buffer.isBuffer(content) ? content : new Buffer(content), { correlationId: correlationId, replyTo: q.queue });
        ...
        key: 'serve',
        value: function serve(queue, handler, noAck) {
