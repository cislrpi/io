    ...
    _createClass(CELIO, [{
        ...
        value: function setActiveDisplayContext(appname, reset) {
            ...
            this.getStore().getState("activeDisplayContext").then(function (name) {
                ...
                if (name != appname) {
                    _this2.getStore().setState("activeDisplayContext", appname)(new DisplayContext(appname, _this2)).restoreFromStore({ reset: reset });
                } else {
        ...
        value: function getFocusedDisplayWindow(displayName) {
            var cmd = {
