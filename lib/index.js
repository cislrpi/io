...
module.exports = function () {
    ...
    _createClass(CELIO, [{
        ...
        key: 'getDisplay',
        value: function getDisplay(screenName) {
            return new Display(this, screenName);
        }
    }, {
        key: 'getDisplayContext',
        value: function getDisplayContext() {
        ...
        key: 'createAppContext',
        value: function createAppContext(name) {
            var cmd = {
            ...
            return this.call("global-context", JSON.stringify(cmd)).then(function (m) {
                return JSON.parse(m.toString());
            });
        }
    }, {
        key: 'getAppContext',
        value: function getAppContext(name) {}
    }, {
        key: 'getAllAppContexts',
        value: function getAllAppContexts() {}
    }, {
        key: 'call',
